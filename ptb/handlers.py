...
from ptb.callbacks import Callback, parse_callback_data_string, get_pattern
...
def get_handlers():
    return ConversationHandler(
        ...
        states={
            State.MAIN_MENU: [
                CallbackQueryHandler(handle_tos, get_pattern(Callback.TERMS_OF_SERVICE)),
                CallbackQueryHandler(handle_my_account, get_pattern(Callback.MY_ACCOUNT)),
                CallbackQueryHandler(handle_order_storage, get_pattern(Callback.ORDER_STORAGE)),
            ...
            State.MY_BOX: [
                CallbackQueryHandler(handle_put_items_to_box, get_pattern(Callback.PUT_NEW_ITEMS)),
                CallbackQueryHandler(handle_courier_withdraw_request, get_pattern(Callback.ORDER_DELIVERY)),
                CallbackQueryHandler(handle_my_orders, get_pattern(Callback.MY_ORDERS)),
                CallbackQueryHandler(handle_open_box, get_pattern(Callback.OPEN_BOX)),
                CallbackQueryHandler(handle_my_box, get_pattern(Callback.MY_BOX)),
